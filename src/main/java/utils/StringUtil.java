...
public class StringUtil {
	...
	/*public static <T> T toObj(String str,Class<T> clz){
		...
		try{
			...
			if(clz.isAssignableFrom(Long.class) || clz.isAssignableFrom(long.class)){
				return (T)Long.valueOf(str);
			}

			if(clz.isAssignableFrom(Double.class) || clz.isAssignableFrom(double.class)){
				return (T)Double.valueOf(str);
			}
			if(clz.isAssignableFrom(Date.class)){
				return (T)DateUtil.toDate(str);
			}
		}catch (Exception e){
		}
		return null;
